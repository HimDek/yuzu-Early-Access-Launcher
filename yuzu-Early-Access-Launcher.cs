...
namespace yuzu_Early_Access_Launcher
{
    static class yuzu_Early_Access_Launcher
    {
        ...
        static void Main()
        {
            String theme = "", version = "2.0.0-Preview-1", UserProfile = Environment.GetFolderPath(Environment.SpecialFolder.UserProfile), path = Path.GetDirectoryName(Application.ExecutablePath);
